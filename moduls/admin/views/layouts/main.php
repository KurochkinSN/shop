                        ...
                        <div class="shop-menu pull-right">
                            <ul class="nav navbar-nav">
                                <?php if (!Yii::$app->user->isGuest): ?>
                                    <li><a href="<?=\yii\helpers\Url::to(['/site/logout'])?>"><i class="fa fa-user"></i> Logout <i><?= Yii::$app->user->identity['username'] ?></i></a></li>
                                <?php endif;?>
                    ...
                    <div class="col-sm-9">
                        ...
                        <div class="mainmenu pull-left">
                            <ul class="nav navbar-nav collapse navbar-collapse">
                                ...
                                <li class="dropdown"><a href="<?=\yii\helpers\Url::to('/admin/category/index')?>">Категории<i class="fa fa-angle-down"></i></a>
